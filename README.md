# Luxeholic — Quadra Platform Architecture
...
│                                                                     │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────────────────┐  │
│  │ luxeholic.in│  │luxeholic    │  │  nz.luxeholic.in        │  │
...
```
India store:      https://store.luxeholic.in
Australia store:  https://au.luxeholic.in
New Zealand store: https://nz.luxeholic.in
```
...
2. Click **Add Key**
3. Description: `Luxeholic Frontend`
...
add_action('rest_api_init', function() {
    ...
    add_filter('rest_pre_serve_request', function($value) {
        ...
        $allowed = ['https://luxeholic.in', 'https://au.luxeholic.in', 'https://nz.luxeholic.in'];
...
2. Click **Add project** → name it (e.g. `luxeholic-prod`)
...
2. Register app name (e.g. `luxeholic-web`)

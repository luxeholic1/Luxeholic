...
DOMAIN_NAMES=("luxeholic.com" "au.luxeholic.in" "nz.luxeholic.in" "luxeholic.in" "luxeholic.in.au" "luxeholic.in.nz")
...
echo ""
echo "📝 Next steps:"
echo "1. Test deployment: ./scripts/deploy-multidomain.sh au.luxeholic.in hostinger"

...
const AccountRegister = () => {
  ...
  const formFields = {
    ...
    subHeader: "Join Luxeholic to track orders and save favourites.",
    fields: [
      {
        label: "Name",
        required: false,
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-background">
      <SEO
        title="Create Account | Luxeholic"
        description="Create a Luxeholic account to track orders and save electronics products for later."
      ...
      >
        ...
        <span className="relative z-10 h-full w-full">
          <TechOrbitDisplay iconsArray={iconsArray} text="Luxeholic" />
        </span>
      </span>

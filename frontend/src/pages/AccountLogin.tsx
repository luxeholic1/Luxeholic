...
const AccountLogin = () => {
  ...
  const formFields = {
    header: "Welcome back",
    subHeader: "Sign in to access your Luxeholic account.",
    fields: [
      {
        label: "Email",
        required: true,
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-background">
      <SEO
        title="Sign In | Luxeholic"
        description="Sign in to your Luxeholic account to manage orders, saved products, and profile details."
        url="/account/login"
        noindex
        nofollow
      />

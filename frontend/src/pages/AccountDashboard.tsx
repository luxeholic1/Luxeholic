...
const AccountDashboard = () => {
  ...
  if (!isLoaded) {
    return (
      <Layout>
        <SEO
          title="Account Dashboard | Luxeholic"
          description="Manage your Luxeholic account, orders, saved products, addresses, and profile settings."
          url="/account"
          noindex
          nofollow
        />
  ...
  if (!isSignedIn || !user) {
    return (
      <Layout>
        <SEO
          title="Account Dashboard | Luxeholic"
          description="Sign in to manage your Luxeholic account, orders, saved products, addresses, and profile settings."
          url="/account"
          noindex
          nofollow
        />

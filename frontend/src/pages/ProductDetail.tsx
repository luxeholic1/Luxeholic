...
const ProductDetail = () => {
  ...
  return (
    <Layout>
      <SEO
        title={`${seoProductName} — Buy Online | Luxeholic`}
        description={cleanText(product.description || `Buy ${product.name} online at Luxeholic. Check product availability, coverage details, and shipping options before checkout.`)}
        keywords={`${product.name}, ${product.category}, buy ${product.name} online, luxeholic`}
        url={`/product/${slug}`}
        image={product.image}
        type="product"
        structuredData={[

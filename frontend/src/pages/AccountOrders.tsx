...
const AccountOrders = () => {
  ...
  if (!isLoaded || loading) {
    return (
      <Layout>
        <SEO
          title="Order History | Luxeholic"
          description="View your Luxeholic order history, invoices, and tracking details."
          url="/account/orders"
          noindex
          nofollow
        />
  ...
  if (!isSignedIn || !user) {
    return (
      <Layout>
        <SEO
          title="Order History | Luxeholic"
          description="Sign in to view your Luxeholic order history, invoices, and tracking details."
          url="/account/orders"
          noindex
          nofollow
        />

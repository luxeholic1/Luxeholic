    ...
    <Layout>
      ...
      <CustomerServiceLayout title="Privacy Policy" heroImage="/a2.jpg" heroAlt="Premium electronics privacy and secure shopping at Luxeholic">
        <section>
          ...
          <p className="mt-6">
            Last updated: June 2025. For privacy questions, email <a className="text-neutral-950 underline" href="mailto:support@luxeholic.in">support@luxeholic.in</a> or call +91 92664 33722.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-6">
            Email: <a className="text-neutral-950 underline" href="mailto:support@luxeholic.in">support@luxeholic.in</a> | Phone: +91 92664 33722
          </p>
        </section>

...
const AccountProfile = () => {
  ...
  if (!isLoaded) {
    return (
      <Layout>
        <SEO
          title="Profile Settings | Luxeholic"
          description="Manage your Luxeholic profile, display name, and account email."
          url="/account/profile"
          noindex
          nofollow
        />
  ...
  if (!isSignedIn || !user) {
    return (
      <Layout>
        <SEO
          title="Profile Settings | Luxeholic"
          description="Sign in to manage your Luxeholic profile, display name, and account email."
          url="/account/profile"
          noindex
          nofollow
        />

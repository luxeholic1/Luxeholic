    ...
    <Layout>
      ...
      <CustomerServiceLayout title="Terms & Conditions" heroImage="/a1.jpg" heroAlt="Luxeholic terms for online electronics shopping">
        ...
        <section>
          ...
          <p>
            For questions about these terms, email <a className="text-neutral-950 underline" href="mailto:support@luxeholic.in">support@luxeholic.in</a> or call +91 92664 33722.
          </p>
        </section>

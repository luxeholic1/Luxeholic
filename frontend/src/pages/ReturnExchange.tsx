  ...
  return (
    <Layout>
      ...
      <CustomerServiceLayout title="Return Policy" heroImage="/a2.jpg" heroAlt="Luxeholic return and exchange support">
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Return Window</h3>
          <p>
            ...
            <table className="w-full min-w-[620px] text-left text-sm sm:text-base">
              <tbody className="divide-y divide-border">
                <tr>
                  ...
                  <td className="py-5 align-top">3-7 days from confirmed delivery for most products.</td>
                </tr>
                <tr>
                  <th className="py-5 pr-6 align-top font-serif text-lg font-normal text-noir">Australia</th>
                  <td className="py-5 align-top">3-5 days from confirmed delivery. Australian Consumer Law rights remain unaffected.</td>
                </tr>
                <tr>
                  <th className="py-5 pr-6 align-top font-serif text-lg font-normal text-noir">New Zealand</th>
                  <td className="py-5 align-top">3-5 days from confirmed delivery. Consumer Guarantees Act rights remain unaffected.</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Valid Return Conditions</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Non-Returnable Items</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">How to Initiate a Return</h3>
          <ol className="list-decimal space-y-3 pl-6 marker:text-gold marker:font-serif">
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Refund Timelines</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Return Shipping Fees</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Contact for Returns</h3>
          <p>
            Email <a className="text-noir underline decoration-gold/40 underline-offset-4 hover:text-gold transition-colors" href="mailto:support@luxeholic.in">support@luxeholic.in</a> with your order number before shipping any item back. Phone support is available at +91 92664 33722, Monday to Saturday, 10:00 AM to 6:00 PM IST.
          </p>
        </section>

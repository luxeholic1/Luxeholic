...
const PaymentMethod = () => {
  return (
    <Layout>
      <SEO
        title="Payment Method | Luxeholic"
        description="Secure payment methods accepted by Luxeholic in India, Australia and New Zealand, including UPI, cards, net banking and PayU."
        keywords="luxeholic payment method, UPI, PayU, cards, net banking"
        url="https://luxeholic.in/payment-method"
        type="article"
      />

      <CustomerServiceLayout title="Payment Method" heroImage="/a6.jpg" heroAlt="Luxeholic secure payment methods">
        <section>
          <p>
            Luxeholic offers secure payment options for customers in India, Australia and New Zealand. All checkout pages are protected by SSL/TLS encryption and processed through PCI-DSS compliant payment gateways.
          </p>
        </section>

        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">India</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Australia and New Zealand</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Payment Security</h3>
          <p>
        ...
        <section>
          <h3 className="mb-5 font-serif text-2xl font-light text-noir">Failed Payments</h3>
          <p>

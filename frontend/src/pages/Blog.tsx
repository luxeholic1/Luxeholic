...
const Blog = () => {
  ...
  return (
    <Layout hideBreadcrumb>
      <SEO
        title="Blog — Electronics Guides & Reviews | Luxeholic"
        description="Expert guides, buying advice and reviews on smartphones, laptops, audio, cameras and wearables from the Luxeholic team."
      ...
      {loading ? (
        ...
        <FlowArt aria-label="Luxeholic Journal">
          ...
          <FlowSection aria-label="More from Luxeholic" style={{ backgroundColor: "#0a0a0a", color: "#fff" }}>

...
const Breadcrumb = () => {
  ...
  const currentLabel = breadcrumbItems[breadcrumbItems.length - 1]?.label ?? "Luxeholic";

  const bannerMap: Record<string, { image: string; eyebrow: string; subtitle: string }> = {
    shop: {
      image: "/a1.jpg",
      eyebrow: "Shop Luxeholic",
    ...
    account: {
      image: "/a3.jpg",
      eyebrow: "Account",
      subtitle: "Manage your profile, orders and Luxeholic shopping experience.",
    },
    blog: {
      image: "/a3.jpg",
      eyebrow: "Insights",
      subtitle: "Stories, buying guides and updates from the Luxeholic team.",
    },
    contact: {
      image: "/a3.jpg",
      eyebrow: "Support",
    ...
    privacy: {
      image: "/a6.jpg",
      eyebrow: "Policy",
      subtitle: "How Luxeholic handles your data and shopping privacy.",
    },
    terms: {
      image: "/a6.jpg",
      eyebrow: "Legal",
      subtitle: "Terms and conditions for using Luxeholic services.",
    },
    "shipping-returns": {
      image: "/a6.jpg",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "itemListElement": breadcrumbItems.map((item, index) => ({
              ...
              "position": index + 1,
              "name": item.label,
              "item": `https://luxeholic.com${item.href}`,
            })),
          }),
        }}
      />

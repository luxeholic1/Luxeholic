 ...
 * Three stores:
 *   India   → luxeholic.in
 *   Australia → luxeholic.com.au
 *   New Zealand → luxeholic.co.nz
 */
...
const STORES: StoreOption[] = [
  { country: "India",       code: "IN", flag: "🇮🇳", domain: "luxeholic.in",       currency: "INR", symbol: "₹"   },
  { country: "Australia",   code: "AU", flag: "🇦🇺", domain: "luxeholic.com.au", currency: "AUD", symbol: "A$"  },
  { country: "New Zealand", code: "NZ", flag: "🇳🇿", domain: "luxeholic.co.nz",   currency: "NZD", symbol: "NZ$" },
];

...
const SOCIAL_LINKS = [
  { Icon: Instagram, href: "https://www.instagram.com/luxeholic.in/", label: "Instagram" },
  { Icon: Twitter,   href: "https://x.com/luxeholic",                  label: "Twitter / X" },
  { Icon: Youtube,   href: "https://www.youtube.com/@luxeholic",       label: "YouTube" },
  { Icon: Facebook,  href: "https://www.facebook.com/luxeholic",       label: "Facebook" },
];
...
const Footer = () => {
  ...
  const organizationSchema = {
    ...
    "logo": "https://luxeholic.in/logo.jpeg",
    "description": "Premium electronics curated for the next generation of creators and tech enthusiasts",
    "sameAs": [
      "https://instagram.com/luxeholic",
      "https://twitter.com/luxeholic",
      "https://youtube.com/@luxeholic"
    ],
    "address": {
      "@type": "PostalAddress",
...
<div className="mt-5 rounded-2xl border border-white/14 bg-black/35 p-5 shadow-[0_18px_60px_rgba(0,0,0,0.28)] backdrop-blur-xl">
  <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
    <div>
      ...
      <p className="mt-1 text-sm font-medium text-white/74">Trusted checkout options accepted at Luxeholic.</p>
    </div>
    ...
    return (
      ...
      <div className="relative z-10 border-t border-white/12 bg-black/14 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-[1920px] flex-col items-center justify-between gap-4 px-4 py-6 text-center text-xs font-medium text-white/62 sm:flex-row sm:gap-6 sm:px-6 sm:py-8 sm:text-left md:px-8 lg:px-12 xl:px-16">
          <p>© {currentYear} Luxeholic. All rights reserved. Premium electronics for creators.</p>
      ...
      <div className="relative z-10 hidden h-[18rem] items-center justify-center lg:flex">
        <TextHoverEffect text="Luxeholic" />
      </div>
    </footer>
  );
};

...
const KB: Array<{
  ...
  // Greetings
  {
    ...
    response: "Hey! 👋 Welcome to Luxeholic. I'm your shopping assistant. How can I help you today?",
  ...
  // About
  {
    patterns: [/about|who.*you|company|brand|luxeholic|founded|story/i],
    response:
      "⚡ **About Luxeholic:**\n\nLuxeholic is a premium electronics store serving India, Australia, and New Zealand. We curate tech products for creators, professionals, and enthusiasts.\n\n• Curated product catalog\n• Regional stores for 3 markets\n• Support for eligible product and order requests",
  ...
  // Bye
  {
    ...
    response: "Thanks for chatting! 😊 Happy shopping at Luxeholic. Feel free to come back anytime!",
...
const WELCOME: Message = {
  id: "welcome",
  role: "bot",
  text: "Hi there! 👋 I'm the Luxeholic assistant. Ask me anything about products, shipping, returns, payments, or just search for a product!",
  time: new Date(),
  quickReplies: ["Shipping info", "Return policy", "Payment options", "About Luxeholic"],
};
          ...
          >
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border bg-gradient-to-r from-primary/10 to-accent/10 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold">Luxeholic Assistant</p>
            ...
            <div className="px-4 py-3 border-t border-border shrink-0">
              ...
              <p className="text-center text-[10px] text-muted-foreground/50 mt-2">
                Powered by Luxeholic · Type or tap a suggestion
              </p>
            </div>
          </motion.div>
        )}

...
const COOKIE_CONSENT_KEY = "luxeholic_cookie_consent_v1";
...
const CENTRAL_ANALYTICS_ORIGIN = "https://luxeholic.in";
...
function getSiteHost() {
  return window.location.hostname.replace(/^www\./, "") || "luxeholic.in";
}
